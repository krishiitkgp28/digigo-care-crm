...
export default function Sidebar() {
  ...
  if (isAdmin) {
    navItems = [
      ...
      {
        name: 'All Demos', path: '/demos', icon: (
      ...
      {
        name: 'Demo Management', path: '/demo-management', icon: (
      ...
      {
        name: 'Converted Leads', path: '/converted-leads', icon: (
      ...
      // },
      {
        name: 'Intern Activity', path: '/intern-activity', icon: (
      ...
      {
        name: 'Intern Control', path: '/intern-control', icon: (
  ...
  return (
    <aside className="w-60 bg-white border-r border-gray-200 flex flex-col flex-shrink-0">
      <div className="h-16 flex items-center px-6 border-b border-gray-200">
        <h1 className="text-2xl font-bold text-indigo-600 tracking-tight">HealthCRM</h1>
      </div>
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        {navItems.map((item) => (
          <NavLink
            ...
            to={item.path}
            className={({ isActive }) =>
              `flex items-center px-3 py-2.5 text-sm font-medium transition-colors duration-200 ${isActive
      ...
      {user && (
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center">
            {user.avatar ? (
              <img src={user.avatar} alt="Profile" className="h-9 w-9 flex-shrink-0 rounded-full object-cover border border-gray-200 bg-indigo-50" />
            ) : (
              <div className="h-9 w-9 flex-shrink-0 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold text-sm">
            ...
            <button onClick={handleLogout} className="ml-auto text-gray-400 hover:text-red-600 transition p-1 rounded-md" title="Logout">
